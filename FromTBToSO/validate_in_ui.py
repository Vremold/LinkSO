...
if __name__ == "__main__":
    # Think In Java
    ## Controlling layout: [(4588109, 1.2895833067349431), (23034414, 1.2684497871195755), (25306555, 1.2217114693295417)]
    # The Swing event model: [(47968990, 1.6093069369975526), (2514328, 1.542001853801704), (55512832, 1.5389426576772536)]
    ...
    # section = "The Swing event model"
    # TextbookMatcher().match_in_textbook(textbook_code_element_path, textbook_semantic_path, chapter, section)
    

    # Core Java Volume 1
    # Introduction to Layout Management: [(23034414, 1.177398993230645), (37376915, 1.1520856659621608), (25175536, 1.1207132831885152)]
    ...
    chapter = "User Interface Components with Swing"
    section = "Introduction to Layout Management"
    TextbookMatcher().match_in_textbook(textbook_code_element_path, textbook_semantic_path, chapter, section)