...
class CJ2PATHUTIL(object):
    root_dir = "/home/dell/linkso"
    raw_data_dir = os.path.join(root_dir, "RawData", "CoreJavaVolume2")
    data_dir = os.path.join(root_dir, "TextbookFeature", "CoreJavaVolume2")
    build_dir = os.path.join(root_dir, "build")
    cache_dir = os.path.join(root_dir, "TBDataClean", "CoreJavaVolume2", "cache")

    so_path = os.path.join(root_dir, "SODataClean", "so_posts.csv")

    jdk_api_doc_path = os.path.join(root_dir, "JDKCrawler", "export", "apis.json")
    
    raw_textbook_path = os.path.join(raw_data_dir, "cj2.txt")
    raw_textbook_code_dir = os.path.join(raw_data_dir, "cj2code")
    ...
    # word2vec 
    word2vec_model_path = os.path.join(build_dir, "CoreJavaVolume2", "word2vec.model")
    word2vec_vector_path = os.path.join(build_dir, "CoreJavaVolume2", "word2vec.vec")
