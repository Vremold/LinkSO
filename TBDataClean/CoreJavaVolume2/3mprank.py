...
from config import MPRANK_CONFIG, CJ2PATHUTIL
...
if __name__ == "__main__":
    # truncate_file(CJ2PATHUTIL.textbook_key_phrase_for_section_path)
    # mprank_textbook_section(CJ2PATHUTIL.textbook_dir, CJ2PATHUTIL.textbook_key_phrase_for_section_path)
    truncate_file(CJ2PATHUTIL.textbook_key_phrase_for_chapter_path)
    mprank_textbook_chapter(CJ2PATHUTIL.textbook_dir, CJ2PATHUTIL.textbook_key_phrase_for_chapter_path)