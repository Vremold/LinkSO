...
from config import MPRANK_CONFIG, TIJPATHUTIL
...
if __name__ == "__main__":
    # truncate_file(TIJPATHUTIL.textbook_key_phrase_for_section_path)
    # mprank_textbook_section(TIJPATHUTIL.textbook_dir, TIJPATHUTIL.textbook_key_phrase_for_section_path)
    truncate_file(TIJPATHUTIL.textbook_key_phrase_for_chapter_path)
    mprank_textbook_chapter(TIJPATHUTIL.textbook_dir, TIJPATHUTIL.textbook_key_phrase_for_chapter_path)