...
class TextbookCodeElementExtractor(object):
    def __init__(self):
        self.cee = CodeElementExtractor(refer_api_doc=TIJPATHUTIL.jdk_api_doc_path)
...
if __name__ == "__main__":
    ...
    tcee.extract_code_element(TIJPATHUTIL.textbook_dir, TIJPATHUTIL.textbook_code_dir, TIJPATHUTIL.textbook_code_element_path)
