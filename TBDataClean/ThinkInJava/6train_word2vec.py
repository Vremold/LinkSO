...
from config import WORD_EMBEDDING_CONFIG, TIJPATHUTIL
...
if __name__ == "__main__":
    ...
    so_corpus = load_so_corpus(TIJPATHUTIL.so_path)
    print("loading textbook_corpus...")
    textbook_corpus = load_textbook_corpus(TIJPATHUTIL.textbook_dir)

    if SAVE_CORPUS:
        with open(os.path.join(TIJPATHUTIL.cache_dir, "word2vec_corpus"), "w", encoding="utf-8") as outf:
    ...
    train_word2vec_model(
        ...
        TIJPATHUTIL.word2vec_model_path,
        TIJPATHUTIL.word2vec_vector_path)
    # pass
    # corpus = []
    # with open(os.path.join(TIJPATHUTIL, "word2vec_corpus"), "r", encoding="utf-8") as inf:
    #     for line in inf:
    ...
    # generate_tb_semantic_feature(TIJPATHUTIL.textbook_summary_path, TIJPATHUTIL.textbook_semantic_path, TIJPATHUTIL.word2vec_vector_path)
    pass