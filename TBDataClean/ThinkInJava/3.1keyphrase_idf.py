...
def keyphrase_chapter_idf():
    chapter_kws = dict()
    with open(TIJPATHUTIL.textbook_key_phrase_for_chapter_path, "r", encoding="utf-8") as inf:
        for line in inf:
    ...
    with open(TIJPATHUTIL.textbook_key_phrase_idf_path, "w", encoding="utf-8") as outf:
