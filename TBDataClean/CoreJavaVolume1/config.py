...
class CJ1PATHUTIL(object):
    root_dir = "/home/dell/linkso"
    raw_data_dir = os.path.join(root_dir, "RawData", "CoreJavaVolume1")
    data_dir = os.path.join(root_dir, "TextbookFeature", "CoreJavaVolume1")
    build_dir = os.path.join(root_dir, "build")
    cache_dir = os.path.join(root_dir, "SODataClean", "CoreJavaVolume1", "cache")

    so_path = os.path.join(root_dir, "SODataClean", "so_posts.csv")

    jdk_api_doc_path = os.path.join(root_dir, "JDKCrawler", "export", "apis.json")
    
    raw_textbook_path = os.path.join(raw_data_dir, "cj1.txt")
    raw_textbook_code_dir = os.path.join(raw_data_dir, "cj1code")
    ...
    # word2vec 
    word2vec_model_path = os.path.join(build_dir, "CoreJavaVolume1", "word2vec.model")
    word2vec_vector_path = os.path.join(build_dir, "CoreJavaVolume1", "word2vec.vec")
