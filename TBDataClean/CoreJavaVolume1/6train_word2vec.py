...
from config import WORD_EMBEDDING_CONFIG, CJ1PATHUTIL
...
if __name__ == "__main__":
    ...
    # so_corpus = load_so_corpus(CJ1PATHUTIL.so_path)
    # print("loading textbook_corpus...")
    # textbook_corpus = load_textbook_corpus(CJ1PATHUTIL.textbook_dir)

    # if SAVE_CORPUS:
    #     with open(os.path.join(CJ1PATHUTIL.cache_dir, "word2vec_corpus"), "w", encoding="utf-8") as outf:
    ...
    #     CJ1PATHUTIL.word2vec_model_path,
    #     CJ1PATHUTIL.word2vec_vector_path)
    # pass
    # corpus = []
    # with open(os.path.join(CJ1PATHUTIL, "word2vec_corpus"), "r", encoding="utf-8") as inf:
    #     for line in inf:
    ...
    generate_tb_semantic_feature(CJ1PATHUTIL.textbook_summary_path, CJ1PATHUTIL.textbook_semantic_path, CJ1PATHUTIL.word2vec_vector_path)
    pass