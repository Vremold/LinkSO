...
class TextbookCodeElementExtractor(object):
    def __init__(self):
        self.cee = CodeElementExtractor(refer_api_doc=CJ1PATHUTIL.jdk_api_doc_path)
...
if __name__ == "__main__":
    ...
    tcee.extract_code_element(CJ1PATHUTIL.textbook_dir, CJ1PATHUTIL.textbook_code_dir, CJ1PATHUTIL.textbook_code_element_path)
