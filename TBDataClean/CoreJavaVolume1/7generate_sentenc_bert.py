...
if __name__ == "__main__":
    # get_textbook_summary_semantic(CJ1PATHUTIL.textbook_summary_path, CJ1PATHUTIL.textbook_bert_semantic_path)
    get_textbook_semantic(CJ1PATHUTIL.textbook_dir, CJ1PATHUTIL.textbook_bert_semantic_path)
