...
if __name__ == "__main__":
    truncate_file(EJPATHUTIL.textbook_key_phrase_for_section_path)
    mprank_textbook_section(EJPATHUTIL.textbook_dir, EJPATHUTIL.textbook_key_phrase_for_section_path)
    # truncate_file(EJPATHUTIL.textbook_key_phrase_for_chapter_path)
    # mprank_textbook_chapter(EJPATHUTIL.textbook_dir, EJPATHUTIL.textbook_key_phrase_for_chapter_path)