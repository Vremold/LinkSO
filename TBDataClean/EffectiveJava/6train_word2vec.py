...
from config import WORD_EMBEDDING_CONFIG, EJPATHUTIL
...
if __name__ == "__main__":
    ...
    # so_corpus = load_so_corpus(EJPATHUTIL.so_path)
    # print("loading textbook_corpus...")
    # textbook_corpus = load_textbook_corpus(EJPATHUTIL.textbook_dir)

    # if SAVE_CORPUS:
    #     with open(os.path.join(EJPATHUTIL.cache_dir, "word2vec_corpus"), "w", encoding="utf-8") as outf:
    ...
    #     EJPATHUTIL.word2vec_model_path,
    #     EJPATHUTIL.word2vec_vector_path)
    # print("training word2vec finished!")
    # pass
    # corpus = []
    # with open(os.path.join(EJPATHUTIL, "word2vec_corpus"), "r", encoding="utf-8") as inf:
    #     for line in inf:
    ...
    generate_tb_semantic_feature(EJPATHUTIL.textbook_summary_path, EJPATHUTIL.textbook_semantic_path, EJPATHUTIL.word2vec_vector_path)
    pass