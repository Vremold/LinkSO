...
def validate_train(cx, cy, cz, sx, sy, sz, outf):
    ...
    print(chapter_right1, chapter_right3, section_right1, section_right3, total_samples)
...
if __name__ == "__main__":
    ...
    # validate(0, 0.21, 0.79, 0, 0.14, 0.86, "validate_result.txt")
    # validate_train(0.0, 0.21, 0.79, 0.0, 0.4, 0.6, "train_result.txt")